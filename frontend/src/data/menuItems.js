    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Integrity Flags', labelKey: 'nav.integrity_flags',icon: Flag,     path: '/integrity-flags',     visibility: 'roles' },
      ...
      { label: 'Security',    labelKey: 'nav.security', icon: ShieldAlert,   path: '/admin/security', visibility: 'admin' },
