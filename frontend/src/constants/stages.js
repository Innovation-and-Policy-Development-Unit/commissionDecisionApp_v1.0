...
export const STAGE_LABELS = {
  ...
  deferred_back_to_unit:      'Deferred Back to Unit',
  // Post-decision
...
export const STAGE_META = {
  ...
  noted:                      { color: 'teal',   category: 'Decision',        terminal: false },
  not_approved:               { color: 'rose',   category: 'Decision',        terminal: false },
  ...
  deferred_back_to_unit:      { color: 'orange', category: 'Decision',        terminal: false },
...
export const PHASES = [
  ...
  { key: 'decision',    label: 'Decision',          color: 'emerald',  stages: ['approved', 'noted', 'not_approved', 'rejected', 'deferred_back_to_hr', 'deferred_back_to_unit', 'minutes_drafted_signed'] },
