...
export default function StaffChatPanel({ open, onClose }) {
  ...
  return (
    <>
      ...
      >
        ...
        <StaffChatWidget variant="panel" enabled={open} showHistory />
      </div>
    </>
  )
}
