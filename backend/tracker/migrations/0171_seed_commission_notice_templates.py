...
NEW_SLUGS = ("agenda_circulated", "minutes_signed")


def seed_templates(apps, schema_editor):
    """Add the agenda-circulated and minutes-signed templates; never clobber
    existing/customized ones."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("tracker", "0170_seed_lockout_email_templates"),
    ]
