...
SLUG_META: dict[str, tuple[str, str, str]] = {
    ...
    "agenda_circulated_fr": ("megaphone", "indigo", "Ordre du jour diffusé"),
    "agenda_circulated_bi": ("megaphone", "indigo", "Adjenda i sekulet"),
    "agenda_amended": ("refresh-cw", "amber", "Agenda amended"),
    "agenda_amended_fr": ("refresh-cw", "amber", "Ordre du jour modifié"),
    "agenda_amended_bi": ("refresh-cw", "amber", "Adjenda i jenis"),
