...
SAMPLE_LETTER_CONTEXT_OVERRIDES = {
    ...
    "RECRUIT-ACTING": {"officer_name": "John Smith", "position_title": "Manager HRM", "period": "1 July 2026 until further decision by the Commission", "post_number_line": ""},
    "RECRUIT-ELIGIBLE": {"applicant_name": "John Smith", "position_title": "Senior Officer", "post_ref": "Senior Officer - Post No. MPM-014"},
    "RECRUIT-UNSUCCESSFUL": {"position_title": "Senior Officer"},
