"""
RECRUIT-CONTRACT (Contract Employment)'s 28 digitized fields have no
start_new_page breaks, same root cause as
0226_recruit_direct_field_pagination.py /
0227_recruit_temporary_field_pagination.py. Marks the existing top-level
section headers as page breaks so it renders as a proper 5-step wizard.

Steps after this: Meeting/Reference, Candidate & Contract Details (incl.
the Break-in-Service / Performance Assessment / Merit Process / Financial
Visa / PSC Form 3-7 / TOR-JD / Agreement of Service attachment checks),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tracker', '0227_recruit_temporary_field_pagination'),
    ]
