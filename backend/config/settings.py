...
if not SECRET_KEY:
    raise ImproperlyConfigured(
        "DJANGO_SECRET_KEY is not set. Refusing to start with no secret key — "
...
# Dashboard/analytics aggregates change whenever a submission is written, so a
