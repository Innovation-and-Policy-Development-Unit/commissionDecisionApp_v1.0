...
DEFAULT_LETTER_TEMPLATES = [
    ...
    {
        "form_type_code": "RECRUIT-ACTING",
        "name": "Acting Appointment",
        "category": "recruitment",
        "description": "Sent when the Commission approves an acting appointment.",
        "placeholders": "officer_name, position_title, post_number, post_number_line, department, ministry, salary_grade, period, today, reference_number",
        "subject_template": "Approval of Acting Appointment as {{position_title}} — {{department}}",
        "body_text_template": (
            "PUBLIC SERVICE COMMISSION\nPort Vila, Vanuatu\nDate: {{today}}\n\n"
            "Reference: {{reference_number}}\n\n"
            "TO: {{officer_name}}\n\n"
            "RE: Approval of Acting Appointment as {{position_title}} — {{department}}\n\n"
            "Dear {{officer_name}},\n\n"
            "I am pleased to inform you that, with the powers vested under section "
            "4.2.2(1) & (2) of the PSSM, I hereby appoint you on an acting basis to "
            "the following post as stated below:\n\n"
            "    Post Title:       {{position_title}}\n"
            "{{post_number_line}}"
            "    Salary Grade:     {{salary_grade}}\n"
            "    Department:       {{department}}\n"
            "    Ministry:         {{ministry}}\n\n"
            "Your acting appointment is effective from {{period}}. You are expected "
            "to carry out the full duties and responsibilities of {{position_title}}. The "
            "terms and conditions of service contained in your letter of appointment "
            "remain unchanged.\n\n"
            "On behalf of the Commission, I congratulate you and wish you all the "
            "best in your acting capacity as {{position_title}}.\n\n"
            + SIGNATURE_BLOCK
        ),
    },
    {
        "form_type_code": "RECRUIT-ELIGIBLE",
        "name": "Eligible Candidate Notification",
        "category": "recruitment",
        "description": "Sent to a shortlisted applicant who was recommended as eligible but not selected on this occasion.",
        "placeholders": "applicant_name, position_title, post_number, post_ref, department, ministry, eligibility_expiry, today, reference_number",
        "subject_template": "Application Outcome — {{position_title}}, {{department}}",
        "body_text_template": (
            "PUBLIC SERVICE COMMISSION\nPort Vila, Vanuatu\nDate: {{today}}\n\n"
            "Reference: {{reference_number}}\n\n"
            "TO: {{applicant_name}}\n\n"
            "RE: Application Outcome — {{position_title}}, {{department}}\n\n"
            "Dear {{applicant_name}},\n\n"
            "I refer to your application for the post of {{post_ref}} within the "
            "{{department}}, {{ministry}}.\n\n"
            "Thank you for your interest in applying for this post and for making "
            "yourself available for interview by the Selection Panel. The Commission "
            "carefully considered all applicants for the post and, on this occasion, "
            "you were recommended as an eligible candidate for the position.\n\n"
            "The current policy states that the eligibility list is active until "
            "{{eligibility_expiry}}. Within this period, if the successful applicant withdraws "
            "the offer of appointment or ceases office, the Director-General of "
            "{{ministry}} shall consult with the Commission to appoint you to the "
            "position, or alternatively request approval to re-advertise the "
            "position.\n\n"
            "We encourage you to apply for future vacancies in the Public Service "
            "for which you believe your skills and qualifications make you suitable.\n\n"
            + SIGNATURE_BLOCK
        ),
    },
    {
        "form_type_code": "RECRUIT-UNSUCCESSFUL",
        "name": "Unsuccessful Candidate Notification",
        "category": "recruitment",
        "description": "Sent to an applicant who was not appointed following a competitive merit selection process.",
        "placeholders": "position_title, department, today, reference_number",
        "subject_template": "Application Outcome — {{position_title}}, {{department}}",
        "body_text_template": (
            "PUBLIC SERVICE COMMISSION\nPort Vila, Vanuatu\nDate: {{today}}\n\n"
            "Reference: {{reference_number}}\n\n"
            "RE: Application Outcome — {{position_title}}, {{department}}\n\n"
            "Dear Applicant,\n\n"
            "Thank you for your application for the position of {{position_title}} within "
            "{{department}}.\n\n"
            "Following a competitive merit selection process, the Public Service Commission "
            "has appointed another candidate to this position. We regret to advise that "
            "your application has been unsuccessful on this occasion.\n\n"
            "We encourage you to apply for future vacancies in the Public Service "
            "and thank you for your interest in serving the people of Vanuatu.\n\n"
            + SIGNATURE_BLOCK
        ),
    },
    {
